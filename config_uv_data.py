...
def config_uv_data(h5, tbl_uv_data, shortcut=False):
...
def main():
  ...
  # Open the hdf data file, and the pre-generated blank fits file
  ...
  print("opening fits template %s"%fitsfile)
  fits = pf.open(fitsfile)
  tbl_uv_data = fits[5]
  
  # Now, run the main config function
  tbl_uv_data = config_uv_data(h5, tbl_uv_data)
