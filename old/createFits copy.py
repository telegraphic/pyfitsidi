...
def make_array_geometry():
  ...
  c.append(pf.Column(name='STABXYZ', format='3D', unit='METERS'))
  c.append(pf.Column(name='DERXYZ',  format='3E', unit='METERS/SEC'))
  c.append(pf.Column(name='ORBPARM', format='1D'))
  c.append(pf.Column(name='NOSTA',   format='1J'))
  c.append(pf.Column(name='MNTSTA',  format='1J'))
  c.append(pf.Column(name='STAXOF',  format='3E', unit='METERS'))
  ...
  # Generate a data placeholder
  data = np.zeros(32, dtype='a8,3float64,3float32,float64,int32,int32,3float32')
...
def make_antenna():
  ...
  c.append(pf.Column(name='POLYTYA',    format='1A'))
  c.append(pf.Column(name='POLAA',      format='1E', unit='DEGREES'))
  c.append(pf.Column(name='POLCALA',   format='1E'))
  c.append(pf.Column(name='POLYTYB',   format='1A'))
  c.append(pf.Column(name='POLAB',     format='1E', unit='DEGREES'))
...
def make_frequency():
  ...
  c.append(pf.Column(name='FREQID',   format='1J'))
  c.append(pf.Column(name='BANDFREQ', format='1D', unit='HZ'))
  c.append(pf.Column(name='CH_WIDTH', format='1E', unit='HZ'))
  c.append(pf.Column(name='TOTAL_BANDWIDTH', format='1E', unit='HZ'))
...
def make_bandpass():
  ...
  c.append(pf.Column(name='ARRAY',     format='1J'))
  c.append(pf.Column(name='FREQID',    format='1J'))
  c.append(pf.Column(name='BANDWIDTH', format='1E', unit='HZ'))
  c.append(pf.Column(name='BAND_FREQ', format='1D', unit='HZ'))
...
def make_source():
    ...
    c.append(pf.Column(name='ID_NO',    format='1J'))
    ...
    c.append(pf.Column(name='RAEPO',    format='1D', unit='DEGREES'))
    c.append(pf.Column(name='DECPO',    format='1D', unit='DEGREES'))
    c.append(pf.Column(name='EPOCH',    format='1D'))
    c.append(pf.Column(name='RAAPP',    format='1D', unit='DEGREES'))
    c.append(pf.Column(name='DECAPP',   format='1D', unit='DEGREES'))
    c.append(pf.Column(name='SYSVEL',   format='2D', unit='METERS/SEC'))
    c.append(pf.Column(name='VELTYP',   format='8A'))
    c.append(pf.Column(name='VELDEF',   format='8A'))
    c.append(pf.Column(name='RESTFREQ', format='1D', unit='HZ'))
    c.append(pf.Column(name='PMRA',     format='1D', unit='DEGREES/DAY'))
    c.append(pf.Column(name='PMDEC',    format='1D', unit='DEGREES/DAY'))
    c.append(pf.Column(name='PARALLAX', format='1E', unit='ARCSEC'))
...
def make_uv_data():
  ...
  c.append(pf.Column(name='UU',        format='1E', unit='SECONDS'))
  c.append(pf.Column(name='VV',        format='1E', unit='SECONDS'))
  c.append(pf.Column(name='WW',        format='1E', unit='SECONDS'))
  c.append(pf.Column(name='DATE',      format='1D', unit='DAYS'))
  c.append(pf.Column(name='TIME',      format='1D', unit='DAYS'))
  c.append(pf.Column(name='BASELINE',  format='1J'))
  c.append(pf.Column(name='FILTER',    format='1J'))
  c.append(pf.Column(name='SOURCE',    format='1J'))
  c.append(pf.Column(name='FREQID',    format='1J'))
  c.append(pf.Column(name='INTTIM',    format='1E', unit='SECONDS'))
  c.append(pf.Column(name='WEIGHT',    format='1024E'))
  c.append(pf.Column(name='GATEID',    format='1J'))
  c.append(pf.Column(name='FLUX',      format='1024E', unit='JY'))
...
def main():
  """
  Mandatory keywords:
  NO_STKD I The number of Stokes parameters
  STK_1 I The first Stokes parameter
  NO_BAND I The number of bands
  NO_CHAN I The number of spectral channels
  REF_FREQ E The file reference frequency in Hz
  CHAN_BW E Channel bandwidth in Hz for the first band in the frequency
  group with frequency ID number 1
  REF_PIXL E The reference pixel for the frequency axis
  """
  ...
  filename = 'medicina.fits'
  if(os.path.isfile(filename)):
    print('Removing existing file...')
    os.remove('medicina.fits')
  print('Writing to file...')
  hdulist.writeto('medicina.fits')
